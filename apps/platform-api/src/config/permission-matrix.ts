...
export const PERMISSION_MATRIX: PermissionMatrixEntry[] = [
  ...
  { scope: 'organization', resource: 'approved_oauth_apps', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  ...
  { scope: 'organization', resource: 'integrations.github_connections', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  ...
  { scope: 'organization', resource: 'integrations.vercel_connections', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  ...
  { scope: 'organization', resource: 'stripe.customer', action: PermissionAction.BILLING_WRITE, roles: ['owner', 'admin'] },
  ...
  { scope: 'organization', resource: 'stripe.payment_methods', action: PermissionAction.BILLING_WRITE, roles: ['owner', 'admin'] },
  ...
  { scope: 'organization', resource: 'stripe.subscriptions', action: PermissionAction.BILLING_WRITE, roles: ['owner', 'admin'] },
  { scope: 'organization', resource: 'stripe.tax_ids', action: PermissionAction.BILLING_READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  { scope: 'organization', resource: 'stripe.tax_ids', action: PermissionAction.BILLING_WRITE, roles: ['owner', 'admin'] },
  { scope: 'organization', resource: 'user_invites', action: PermissionAction.CREATE, roles: ['owner', 'admin', 'developer'] },
  { scope: 'organization', resource: 'user_invites', action: PermissionAction.DELETE, roles: ['owner', 'admin'] },
  ...
  { scope: 'project', resource: '%', action: PermissionAction.SECRETS_WRITE, roles: ['owner', 'admin'] },
  { scope: 'project', resource: '%', action: PermissionAction.STORAGE_ADMIN_READ, roles: ['owner', 'admin', 'developer'] },
  { scope: 'project', resource: '%', action: PermissionAction.STORAGE_ADMIN_WRITE, roles: ['owner', 'admin'] },
  ...
  { scope: 'project', resource: 'custom_config_gotrue', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  { scope: 'project', resource: 'custom_config_gotrue', action: PermissionAction.UPDATE, roles: ['owner', 'admin', 'developer'] },
  { scope: 'project', resource: 'custom_config_postgrest', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  { scope: 'project', resource: 'custom_config_postgrest', action: PermissionAction.UPDATE, roles: ['owner', 'admin'] },
  ...
  { scope: 'project', resource: 'preview_branches', action: PermissionAction.CREATE, roles: ['owner', 'admin', 'developer'] },
  { scope: 'project', resource: 'preview_branches', action: PermissionAction.DELETE, roles: ['owner', 'admin', 'developer'] },
  { scope: 'project', resource: 'preview_branches', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },
  { scope: 'project', resource: 'preview_branches', action: PermissionAction.UPDATE, roles: ['owner', 'admin', 'developer'] },
  ...
  { scope: 'project', resource: 'queue_job.projects.update_jwt', action: PermissionAction.INFRA_EXECUTE, roles: ['owner', 'admin'] },
  ...
  { scope: 'project', resource: 'reboot', action: PermissionAction.INFRA_EXECUTE, roles: ['owner', 'admin', 'developer'] },
  ...
  { scope: 'project', resource: 'user_content', action: PermissionAction.READ, roles: ['owner', 'admin', 'developer', 'read_only'] },

module github.com/supabase/supabase/apps/runtime-agent
...
require (
	...
	github.com/supabase/supabase/apps/runtime-agent/pkg v0.0.0
...
replace github.com/supabase/supabase/apps/runtime-agent/pkg v0.0.0 => ./pkg

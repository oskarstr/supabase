...
exports.SMART_REGION_TO_EXACT_REGION_MAP = exports.LOCAL_REGIONS = exports.FLY_REGIONS = exports.AWS_REGIONS = void 0;
exports.AWS_REGIONS = {
    WEST_US: {
        code: 'us-west-1',
...
exports.LOCAL_REGIONS = {
    LOCAL_DEV: { code: 'local-dev', displayName: 'Local Development', location: [0, 0] },
};
exports.SMART_REGION_TO_EXACT_REGION_MAP = new Map([
